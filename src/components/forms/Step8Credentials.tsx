...
const CredentialForm: React.FC<{
  ...
  onInputChange: (field: keyof Credential, value: string) => void;
  onDateChange: (field: 'dateIssued' | 'expirationDate', value: string) => void;
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Input
          ...
          onChange={(e) => onInputChange('certificateName', e.target.value)}
        ...
        <Input
          ...
          onChange={(e) => onInputChange('issuer', e.target.value)}
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Input
          ...
          onChange={(e) => onDateChange('dateIssued', e.target.value)}
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Input
          ...
          onChange={(e) => onInputChange('credentialId', e.target.value)}
        ...
        <Input
          ...
          onChange={(e) => onInputChange('securityClearance', e.target.value)}
      ...
      <Textarea
        ...
        onChange={(e) => onInputChange('volunteerWork', e.target.value)}
...
Local Food Bank - Board Member (2019-2021)"
      ...
      <Textarea
        ...
        onChange={(e) => onInputChange('militaryService', e.target.value)}
...
const CredentialList: React.FC<{
  ...
  onAddNew: () => void;
  onPreview: () => void;
}> = ({ credentials, onEdit, onDelete, onAddNew, onPreview }) => {
        ...
        <Card key={cred.id} variant="outlined" padding="md" className="animate-fade-in">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0 flex-1">
              ...
              <p className="font-medium text-indigo-600 dark:text-indigo-400">{cred.issuer}</p>
    ...
    <div className="flex items-start gap-4">
      ...
      <div className="flex-1">
        ...
        <ul className="mt-2 space-y-1 text-sm text-slate-600 dark:text-slate-400">
          ...
          <li>
            • <strong>Volunteer work</strong> - Shows character, leadership, community involvement
          </li>
          <li>
            • <strong>Hobbies</strong> - Relevant interests can spark interview conversation
          </li>
          <li>
            • <strong>Military service</strong> - Valued by many employers, highlight transferable
            skills
          </li>
          <li>
...
export const Step8Credentials: React.FC = () => {
  ...
  const formState = formContext as FormState;
  const { addCredential, updateCredential, removeCredential, clearError, errors } = formContext;
