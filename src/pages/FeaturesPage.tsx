...
export const FeaturesPage: React.FC = () => (
  <div className="min-h-screen bg-slate-50 pt-24 pb-16 dark:bg-slate-950">
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        {[
          {
            ...
            desc: 'Choose from multiple ATS-friendly templates designed by professionals.',
          },
          {
            title: 'Step-by-Step Builder',
            desc: 'Guided 9-step process ensures you never miss important information.',
          },
          {
            title: 'PDF Export',
            desc: 'Download your CV as a high-quality, print-ready PDF file.',
          },
          { title: 'DOCX Export', desc: 'Export to Word format for easy editing and sharing.' },
          {
            title: 'AI Suggestions',
            desc: 'Get smart suggestions for your professional summary and experience.',
          },
          { title: 'Dark Mode', desc: 'Easy on the eyes with full dark mode support.' },
          {
            title: 'Auto-Save',
            desc: 'Your progress is automatically saved. Never lose your work.',
          },
          { title: 'Mobile Friendly', desc: 'Build your CV on any device, anywhere.' },
          {
            title: 'Rich Text Editor',
            desc: 'Format your descriptions with bold, italic, lists, and more.',
          },
        ].map((f) => (
          <div
            key={f.title}
      ...
      <Link
        to="/"
        className="mt-12 inline-flex items-center text-indigo-600 hover:text-indigo-700 dark:text-indigo-400"
      >
